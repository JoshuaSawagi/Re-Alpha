...
unsafe extern "C" fn game_wolf_speciallwstart(agent: &mut L2CAgentBase) {
...
pub fn install() {
    Agent::new("wolf")
    .acmd("game_specialairlwstart", game_wolf_speciallwstart, Priority::Low)
    .acmd("game_speciallwstart", game_wolf_speciallwstart, Priority::Low)
    .install();
}