use crate::imports::BuildImports::L2CFighterCommon_status_pre_GuardDamage;
use crate::FIGHTER_STATUS_ATTR_DISABLE_SHIELD_RECOVERY;
use crate::FighterStatusModuleImpl;
use crate::FIGHTER_TREADED_KIND_NO_REAC;
use crate::FS_SUCCEEDS_KEEP_VISIBILITY;
use crate::FIGHTER_STATUS_WORK_KEEP_FLAG_GUARD_DAMAGE_FLOAT;
use crate::FIGHTER_STATUS_WORK_KEEP_FLAG_GUARD_DAMAGE_INT;
use crate::FIGHTER_STATUS_WORK_KEEP_FLAG_GUARD_DAMAGE_FLAG;
use crate::GROUND_CLIFF_CHECK_KIND_NONE;
use crate::imports::BuildImports::GroundCliffCheckKind;
use crate::GROUND_CORRECT_KIND_GROUND_CLIFF_STOP;
use crate::FIGHTER_KINETIC_TYPE_MOTION;
use crate::SITUATION_KIND_GROUND;
...
use smash::lua2cpp::L2CFighterCommon_sub_ftStatusUniqProcessGuardDamage_initStatus;
use smashline::Hash40;
use smash::app::lua_bind::ModelModule;
use smash::app::lua_bind::WorkModule;
use smash::lib::lua_const::FIGHTER_STATUS_GUARD_DAMAGE_WORK_FLOAT_PREV_SHIELD;
use smash::lib::lua_const::FIGHTER_INSTANCE_WORK_ID_FLOAT_GUARD_SHIELD;
use smash::lib::lua_const::FIGHTER_STATUS_GUARD_DAMAGE_WORK_INT_PREV_SHIELD_SCALE_FRAME;
use smash::lib::lua_const::FIGHTER_STATUS_KIND_GUARD_ON;
use crate::consts::globals::PREV_STATUS_KIND;
use crate::FIGHTER_STATUS_GUARD_ON_WORK_FLAG_JUST_SHIELD;
use crate::FIGHTER_STATUS_GUARD_DAMAGE_WORK_FLOAT_HIT_STOP_FRAME;
use crate::imports::BuildImports::capture;
use crate::imports::BuildImports::hash40;
use crate::ShieldModule;
use smash_script::lua_args;
use smash_script::sv_kinetic_energy;
use smash::lib::lua_const::FIGHTER_STATUS_GUARD_DAMAGE_WORK_FLOAT_SHIELD_POWER;
use smash::lib::lua_const::FIGHTER_STATUS_GUARD_DAMAGE_WORK_FLOAT_SHIELD_SETOFF_MUL;
use crate::FIGHTER_STATUS_GUARD_DAMAGE_WORK_INT_OBJECT_ID;
use crate::BATTLE_OBJECT_ID_INVALID;
use crate::MA_MSC_CMD_CAPTURE_SET_IGNORE_OBJECT_ID;
use crate::FIGHTER_INSTANCE_WORK_ID_INT_GUARD_INVALID_CAPTURE_FRAME;
use crate::FIGHTER_STATUS_GUARD_DAMAGE_WORK_INT_STIFF_FRAME;
use crate::FIGHTER_INSTANCE_WORK_ID_INT_INVALID_CATCH_FRAME;
use smash::app::sv_fighter_util;
use crate::MotionModule;
use crate::FIGHTER_INSTANCE_WORK_ID_FLAG_IGNORE_2ND_MOTION;
use crate::FIGHTER_STATUS_GUARD_ON_WORK_FLOAT_PREV_X;
use crate::FIGHTER_STATUS_GUARD_ON_WORK_FLOAT_PREV_Y;
use crate::FighterMotionModuleImpl;
use crate::imports::BuildImports::L2CFighterCommon_sub_ftStatusUniqProcessGuardDamage_initStatus_Inner;
use smash::app::lua_bind::KineticModule;
use smash::lib::lua_const::FIGHTER_KINETIC_ENERGY_ID_DAMAGE;
use smash::app::sv_battle_object;
use smash::lib::lua_const::FIGHTER_STATUS_GUARD_DAMAGE_WORK_FLOAT_SHIELD_LR;
use smash::lib::lua_const::ENERGY_STOP_RESET_TYPE_GUARD_DAMAGE;
use smash::lib::lua_const::BATTLE_OBJECT_CATEGORY_FIGHTER;
use smash::app::lua_bind::ControlModule;
use smash::lib::lua_const::SHIELD_STATUS_NORMAL;
use smash::app::ShieldStatus;
use smash::lib::lua_const::FIGHTER_SHIELD_KIND_GUARD;
use smash::lib::lua_const::FIGHTER_REFLECTOR_GROUP_JUST_SHIELD;
use smash::app::lua_bind::ReflectorModule;
use smash::app::FighterUtil;
use crate::consts::globals::MODULE_ACCESSOR;
use smash::lib::lua_const::SHIELD_TYPE_JUST_SHIELD;
use smash::app::ShieldType;
use smash::lib::lua_const::FIGHTER_STATUS_GUARD_ON_WORK_FLAG_DISABLE_HIT_STOP_DELAY_STICK;
use smash::app::lua_bind::CancelModule;
use smash::lib::lua_const::FIGHTER_STATUS_GUARD_ON_WORK_INT_JUST_SHEILD_COUNT;
use smash::lib::lua_const::FIGHTER_ANIMCMD_EXPRESSION;
use smash::app::lua_bind::MotionAnimcmdModule;
use smash_script::notify_event_msc_cmd;
use crate::consts::globals::STICK_X;
use smash::lib::lua_const::FIGHTER_STATUS_GUARD_ON_WORK_INT_MIN_FRAME;
use smash::lib::lua_const::FIGHTER_STATUS_TRANSITION_TERM_ID_CONT_GUARD;
use smash::lib::lua_const::FIGHTER_INSTANCE_WORK_ID_INT_DISABLE_GUARD_FRAME;
use smash::lib::lua_const::FIGHTER_INSTANCE_WORK_ID_INT_DISABLE_ESCAPE_FRAME;
use smash::app::lua_bind::HitModule;
use smash::app::HitStatus;
use smash::lib::lua_const::HIT_STATUS_XLU;
use smash::lib::lua_const::FIGHTER_STATUS_GUARD_ON_WORK_FLAG_HIT_XLU;
use smash::lib::lua_const::FIGHTER_INSTANCE_WORK_ID_FLAG_FINAL;
use smash::lib::lua_const::FIGHTER_STATUS_GUARD_DAMAGE_WORK_FLAG_GOLD_EYE;
use smash::app::lua_bind::EffectModule;
use smash::lib::lua_const::EFFECT_SUB_ATTRIBUTE_NONE;
use smash::lib::lua_const::EFFECT_FLIP_NONE;
use smash::app::lua_bind::ColorBlendModule;
use smash::lib::lua_const::FIGHTER_STATUS_KIND_GUARD_OFF;
use smash::app::lua_bind::SoundModule;
use crate::consts::globals::FIGHTER_KIND;
use smash::app::enSEType;
use smash::lib::lua_const::FIGHTER_STATUS_GUARD_ON_WORK_INT_SHIELD_DAMAGE2_EFFECT_HANDLE;
use smash::lua2cpp::L2CFighterCommon_status_GuardDamage_common;
use crate::consts::globals::SUB_STATUS;
use smash::app::lua_bind::StopModule;
use smash::lib::lua_const::FIGHTER_STATUS_GUARD_ON_WORK_INT_SHIELD_DAMAGE_EFFECT_HANDLE;
use smash::app::EColorKind;
use crate::FIGHTER_KIND_YOSHI;
use smash::lib::lua_const::FIGHTER_STATUS_GUARD_ON_WORK_FLAG_IS_DONE_GUARD_DAMAGE_NUM;
use crate::FIGHTER_LOG_DATA_INT_GUARD_DAMAGE_NUM;
use crate::FIGHTER_KIND_KEN;
use crate::FIGHTER_KIND_RYU;
use crate::FIGHTER_LOG_DATA_INT_JUST_SHIELD;
use smash::lua2cpp::L2CFighterCommon_sub_ftStatusUniqProcessGuardDamage_exitStatus_common;
use smash::lib::lua_const::HIT_STATUS_NORMAL;
use crate::SHIELD_STATUS_NONE;
use smash::lua2cpp::L2CFighterCommon_sub_ftStatusUniqProcessGuardDamage_execStatus_common;
use smash::lua2cpp::L2CFighterCommon_status_GuardDamage_Main;
use smash::lib::lua_const::FIGHTER_STATUS_KIND_GUARD;
use smash::lib::lua_const::FIGHTER_INSTANCE_WORK_ID_FLAG_ENABLE_TRANSITION_STATUS_STOP;
use crate::consts::globals::SITUATION_KIND;
use smash::lua2cpp::L2CFighterCommon_sub_GuardDamageUniq;
use smash::lib::lua_const::FIGHTER_INSTANCE_WORK_ID_INT_DISABLE_JUST_SHIELD_FRAME;
use smash::lib::lua_const::FIGHTER_STATUS_GUARD_ON_WORK_INT_JUST_FRAME;
use crate::CONTROL_PAD_BUTTON_GUARD;
