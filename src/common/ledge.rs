//Credited to WuBoyTH\
use smash::lib::lua_const::FIGHTER_STATUS_CLIFF_FLAG_TO_ROB;
use smash2::app::WorkModule;
use smash2::app::BattleObject;
use super::*;
...
unsafe extern "C" fn reverse_trump_logic(ctx: &mut skyline::hooks::InlineCtx) {
    ...
    WorkModule::set_flag((*opponent_battle_object).module_accessor, *FIGHTER_STATUS_CLIFF_FLAG_TO_ROB);
}
